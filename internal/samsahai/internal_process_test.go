			...
			Status: s2hv1.TeamStatus{
				...
				DesiredComponentImageCreatedTime: map[string]map[string]s2hv1.DesiredImageTime{
					comp1: {
						...
						stringutils.ConcatImageString(repoComp1, v009): s2hv1.DesiredImageTime{
					...
					comp2: {
						...
						stringutils.ConcatImageString(repoComp2, v116): s2hv1.DesiredImageTime{
