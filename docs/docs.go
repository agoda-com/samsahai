...
// 2020-09-13 16:09:14.542403 +0700 +07 m=+0.123229586
    ...
    "definitions": {
        ...
        "v1beta1.ConfigPullRequest": {
            ...
            "properties": {
                ...
                "parallel": {
                    "description": "Parallel defines a parallel number of pull request queue\n+optional",
                    "type": "integer"
                },
                "resources": {
        ...
        "v1beta1.PullRequestComponent": {
            ...
            "properties": {
                "chart": {
                    "description": "Chart defines a chart repository, name and version of pull request component",
                    "type": "object",
                    "$ref": "#/definitions/v1beta1.ComponentChart"
                },
                "dependencies": {
