...
// 2022-10-20 13:25:50.64173 +0700 +07 m=+0.253980743
...
var doc = `{
    ...
    "paths": {
        ...
        "/teams/{team}/pullrequest/trigger": {
            "post": {
                "description": "Endpoint for manually triggering pull request deployment.\nIf testRunner.gitlab.inferBranch is true and testRunner.gitlab.branch is not set,\nit will always try to infer branch regardless of the branch in config.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
    ...
    "definitions": {
        ...
        "v1.ConfigActivePromotionReport": {
            "type": "object",
            "properties": {
                "extraMessage": {
                    "description": "+optional",
        ...
        "v1.ConfigPullRequest": {
            ...
            "properties": {
                ...
                "tearDownDuration": {
                    "description": "TearDownDuration defines duration before teardown the pull request components\n+optional",
                    "type": "object",
                    "$ref": "#/definitions/v1.PullRequestTearDownDuration"
                },
                "trigger": {
        ...
        "v1.ConfigTestRunner": {
            ...
            "properties": {
                "gitlab": {
                    "description": "+optional",
                    "type": "object",
                    "$ref": "#/definitions/v1.ConfigGitlab"
                },
                "pollingTime": {
                    "description": "+optional",
                    "type": "string"
        ...
        "v1.ConfigTestRunnerOverrider": {
            "type": "object",
            "properties": {
                "gitlab": {
                    "description": "+optional",
                    "type": "object",
                    "$ref": "#/definitions/v1.ConfigGitlabOverrider"
                },
                "pollingTime": {
                    "description": "+optional",
                    "type": "string"
                ...
                "teamcity": {
                    "description": "+optional",
                    "type": "object",
                    "$ref": "#/definitions/v1.ConfigTeamcityOverrider"
                },
                "testMock": {
                    "description": "+optional",
                    "type": "object",
        ...
        "v1.PullRequestBundle": {
            ...
            "properties": {
                "components": {
                    "description": "Components represents a list of pull request components which are deployed together as a bundle",
                    "type": "array",
                    "items": {
                ...
                "gitProjectID": {
                    "description": "GitProjectID represents a git repository id\nused for publishing test runner status\n+optional",
                    "type": "string"
                },
                "gitRepository": {
        ...
        "v1.PullRequestQueueSpec": {
            ...
            "properties": {
                ...
                "gitProjectID": {
                    "description": "GitProjectID represents a github project ID of the pull request",
                    "type": "string"
                },
                "gitRepository": {
                    "description": "GitRepository represents a github repository of the pull request",
                    "type": "string"
                },
                "imageMissingList": {
                    "description": "ImageMissingList represents image missing lists\n+optional",
                    "type": "array",
                    "items": {
                ...
                "isPrTriggerFailed": {
                    "description": "IsPRTriggerFailed represents the result of pull request trigger\n+optional",
                    "type": "boolean"
                },
                "noOfOrder": {
                ...
                "prTriggerCreatedAt": {
                    "description": "PRTriggerCreatedAt represents time when pull request trigger has been start\n+optional",
                    "type": "string"
                },
                "prTriggerFinishedAt": {
                    "description": "PRTriggerFinishedAt represents time when pull request trigger has been finish\n+optional",
                    "type": "string"
                },
                "teamName": {
                ...
                "testRunner": {
                    "description": "TestRunner represents configuration about how to test the environment. If defined, this will override\ntestRunner from config\n+optional",
                    "type": "object",
                    "$ref": "#/definitions/v1.ConfigTestRunnerOverrider"
                },
                "upcomingCommitSHA": {
        ...
        "v1.PullRequestQueueStatus": {
            ...
            "properties": {
                ...
                "destroyedTime": {
                    "description": "DestroyedTime represents time at which the PR namespace will be destroyed\n+optional",
                    "type": "string"
                },
        ...
        "v1.PullRequestTearDownDuration": {
            "type": "object",
            "properties": {
                "criteria": {
                ...
                "duration": {
                    "description": "Duration tells how much the staging controller will wait before destroying the pull request namespace",
                    "type": "string"
                }
            }
        },
        ...
        "v1.QueueSpec": {
            ...
            "properties": {
                ...
                "testRunner": {
                    "description": "TestRunner represents configuration about how to test the environment\n+optional",
                    "type": "object",
                    "$ref": "#/definitions/v1.ConfigTestRunnerOverrider"
                },
                "type": {
        ...
        "v1.ReporterSlack": {
            ...
            "properties": {
                "activePromotion": {
                    "description": "+optional",
                    "type": "object",
                    "$ref": "#/definitions/v1.ConfigActivePromotionReport"
                },
                "channels": {
                    "type": "array",
                    "items": {
        ...
        "v1.TeamStatus": {
            ...
            "properties": {
                ...
                "activeDeletedBy": {
                    "description": "ActiveDeletedBy represents a person who deleted the Active environment\n+optional",
                    "type": "string"
                },
                "activePromotedBy": {
