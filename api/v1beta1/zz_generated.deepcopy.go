...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ComponentsValues) DeepCopyInto(out *ComponentsValues) {
	{
		in := &in
		*out = make(ComponentsValues, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentsValues.
func (in ComponentsValues) DeepCopy() ComponentsValues {
	if in == nil {
		return nil
	}
	out := new(ComponentsValues)
	in.DeepCopyInto(out)
	return *out
}
